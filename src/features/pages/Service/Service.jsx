                           ...
                           <div className="row gx-20">
                              <div className="col-lg-6 col-md-12 col-sm-6 mb-25">
                                 <div className="tp-home-2-big-years-wrap text-center h-100">
                                    ...
                                    <h2 className="tp-home-2-big-years mb-0">5</h2>
                                 </div>
                              </div>
                              <div className="col-lg-6  col-md-12 col-sm-6 mb-25">
                                 <div className="tp-home-2-big-years-wrap-2 h-100">
                                    ...
                                    <a href="#" className="tp-btn-2 w-100 d-flex justify-content-between">
                                       Download
                                       <span>
                                          <svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             <path d="M6.8667 1L11 5.00003L6.8667 9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <div className="col-xl-6 col-lg-12 mb-25">
                           <div className="tp-service-wrap">
                              ...
                              <div className="tp-service-body">
                                 ...
                                 <p>I optimize websites for speed, performance, and SEO to boost rankings and engagement. Using lazy loading, image optimization, minification, and caching, I enhance site speed. I follow SEO best practices, including structured data, meta tags, and keyword optimization, to improve search visibility. Whether you need a technical SEO audit or on-page optimization, I provide strategies to maximize performance and organic traffic.</p>
                        ...
                        <div className="col-xl-6 col-lg-12 mb-25">
                           <div className="tp-service-wrap">
                              ...
                              <div className="tp-service-body">
                                 ...
                                 <p>I develop high-performance, cross-platform mobile apps using React Native. <br/> i solutions ensure fast performance, intuitive user <br/> experience, and full functionality across both iOS and Android platforms. From e-commerce and service apps to custom business solutions,<br/> i craft scalable, secure, and <br/> user-friendly mobile apps <br/> that bring your ideas to life effectively.</p>
